...
// Handling errors with a template page.
app.use(function (req, res, next){
    res.render('layout', {content: 'error', err: createError(404), title: "Top 10 Movies - Joe Dimmick"})
})

app.use(function (err, req, res, next){
    res.status(err.status || 500)
    res.render('layout', {content: 'error', title: "Top 10 Movies - Joe Dimmick", err: err })
})
